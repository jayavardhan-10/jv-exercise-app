...
const CreateWorkout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-4 px-2 sm:py-6 sm:px-4 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 transition-all duration-300">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Create New Workout</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-6">
                {exercises.map((exercise) => (
                  <div key={exercise.id} className="border rounded-2xl p-6 bg-white shadow-md hover:shadow-lg transition-all duration-300 flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-green-500 text-white px-6 py-2 rounded-md hover:bg-green-600 transition-all duration-200 text-base sm:text-lg"
              >
              ...
              <button
                ...
                className="flex-1 bg-gray-500 text-white px-6 py-2 rounded-md hover:bg-gray-600 transition-all duration-200 text-base sm:text-lg"
              >
                Cancel
              </button>
            </div>
